  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          {/* PALCO CENTRAL IMERSIVO: FULL-BLEED NO MOBILE / PROPORÇÃO 9:16 COM TRANSIÇÃO EM GRADIENTE NAS LATERAIS NO PC */}
          <div className="relative w-full h-full sm:w-auto sm:h-full sm:aspect-[9/16] sm:max-w-[calc(100dvh*9/16)] flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 w-full h-full sm:[mask-image:linear-gradient(to_right,transparent_0%,black_8%,black_92%,transparent_100%)] sm:[-webkit-mask-image:linear-gradient(to_right,transparent_0%,black_8%,black_92%,transparent_100%)]">
              ...
              {/* Vídeo 'intro-paisdepet.mp4' contínuo em loop da pré-entrada cinematográfica pura */}
              <video
                ref={videoRef}
            ...
            {/* TRANSIÇÃO SUAVE DE GRADIENTE NAS LATERAIS NO DESKTOP (ELIMINA BORDAS RÍGIDAS OU CAIXAS) */}
            ...
            {/* Vinheta sutil na parte inferior para contraste e legibilidade pura */}
            ...
            {/* AMBIENTAÇÃO VISUAL PURA (HEADLINE & ASSINATURA — SEM BOTÃO WHATSAPP E SEM 'CONHECER CLÍNICA') */}
